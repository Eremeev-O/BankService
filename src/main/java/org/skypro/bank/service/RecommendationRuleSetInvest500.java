...
public class RecommendationRuleSetInvest500 implements RecommendationRuleSet {
    ...
    public Optional<Dto> check(UUID user) {
        ...
        Boolean resultA = recommendationsRepository.isUserOf(user, "DEBIT");
        Boolean resultB = !recommendationsRepository.isUserOf(user, "INVEST");
        Boolean resultC = recommendationsRepository.isTransactionsSumCompare(user, "SAVING", "DEPOSIT", ">", 1000);
